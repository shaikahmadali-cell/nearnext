            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '0.75rem' }}>
              <button
                ...
                style={{
                  ...
                  padding: '1rem',
                  borderRadius: 'var(--radius-md)',
                  background: formData.role === 'customer' ? 'rgba(14, 165, 233, 0.18)' : 'rgba(255, 255, 255, 0.04)',
              ...
              <button
                ...
                style={{
                  ...
                  padding: '1rem',
                  borderRadius: 'var(--radius-md)',
                  background: formData.role === 'business' ? 'rgba(56, 189, 248, 0.18)' : 'rgba(255, 255, 255, 0.04)',
